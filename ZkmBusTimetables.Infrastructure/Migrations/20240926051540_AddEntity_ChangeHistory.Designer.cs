...
namespace ZkmBusTimetables.Infrastructure.Migrations
{
    ...
    [Migration("20240926051540_AddEntity_ChangeHistory")]
    partial class AddEntity_ChangeHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZkmBusTimetables.Core.Models.BusStop", b =>
                {
                    ...
                    b.ToTable("BusStops", "identity");
                });

            modelBuilder.Entity("ZkmBusTimetables.Core.Models.ChangeHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ChangeHistory", "identity");
                });
            ...
            modelBuilder.Entity("ZkmBusTimetables.Core.Models.RouteLinePoint", b =>
                {
                    ...
                    b.ToTable("RouteLinePoints", "identity");
                });
                    ...
                    b.OwnsOne("ZkmBusTimetables.Core.Models.Coordinate", "Coordinate", b1 =>
                        {
                            ...
                            b1.ToTable("RouteLinePoints", "identity");
